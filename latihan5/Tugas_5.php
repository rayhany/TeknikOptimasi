...
class Fitness
{
        ...
        if ($numberOfIndividuHasMaxItem === 1) {
            ...
            foreach ($fits as $key => $val) {
                if ($val['numberOfSelectedItem'] === $maxItem) {
                    ...
                    // Mencari nilai fitness yg tertinggi
                    $ret[] = [
                        'individuKey' => $key,
            ...
            // Jika nilai fitness sama | Array unique => menghapus nilai2 yg duplikat
            if (count(array_unique(array_column($ret, 'fitnessValue'))) === 1) {
                // rekomendasi secara acak
    ...
    {
        // Mengambil individu/parcel dengan data yng plng banyak
        ...
        // Jika fitness mendekati minimal angka dari stopping value
    ...
    // Memasukkan produk berdasarkan evaluasi fitness
